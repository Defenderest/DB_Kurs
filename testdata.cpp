...
bool populateTestData(DatabaseManager *dbManager, int numberOfRecords)
{
    ...
    QList<BookData> books = {
        ...
        {"A Game of Thrones", "978-0553593716", QDate(1996, 8, 1), "HarperCollins", 450.00, 60,
         "Перша книга саги 'Пісня льоду й полум'я'. Лорди Вестероса борються за Залізний Трон, не підозрюючи про загрозу з Півночі.",
        ...
        {"A Clash of Kings", "978-0553579901", QDate(1999, 2, 2), "HarperCollins", 480.00, 55,
         "Друга книга саги. Війна П'яти Королів охоплює Вестерос, доки Джон Сноу стикається з небезпеками за Стіною.",
        ...
        {"A Storm of Swords", "978-0553573428", QDate(2000, 11, 1), "HarperCollins", 520.00, 50,
         "Третя книга саги. Війна триває, зради та несподівані союзи змінюють розклад сил. Червоне Весілля шокує королівства.",
        ...
        {"A Feast for Crows", "978-0553582024", QDate(2005, 11, 8), "HarperCollins", 490.00, 45,
         "Четверта книга саги. Події зосереджені на Королівській Гавані, Річкових Землях та Залізних Островах після кривавих подій попередньої книги.",
        ...
        {"A Dance with Dragons", "978-0553582017", QDate(2011, 7, 12), "HarperCollins", 550.00, 40,
         "П'ята книга саги. Повертаємось до подій на Півночі та за Вузьким морем, де Дейнеріс Таргарієн править у Міеріні.",
        ...
        {"Fire & Blood", "978-1524796280", QDate(2018, 11, 20), "HarperCollins", 420.00, 35,
         "Історія дому Таргарієнів, що охоплює період від завоювання Ейгона до Танцю Драконів. Пріквел до основної саги.",
